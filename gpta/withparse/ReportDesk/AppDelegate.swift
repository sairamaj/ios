...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if reachability.isReachable(){
            ...
            Repository.Instance.setNetWork(true)
        }else{
            println("network isn not reachable")
            Parse.enableLocalDatastore()
            Repository.Instance.setNetWork(false)
        ...
        Parse.setApplicationId("eXD3xQdD7tSsVo5hvVcqYqoLuprXsD8Arvgtakvs",
            clientKey: "o5UwlJS2k9DAtvcgkNkIkYmKLmOKf2aNXeiFZOFe")
        
        ReportDeskParser.parse()
